"""
Django settings for PurposesKeeper project.
...
SECRET_KEY = 'django-insecure-(qml2cw88uba$i8!z4lm3cmq&mamst413mdxj)#*lb2klg_h1l'
...
ROOT_URLCONF = 'PurposesKeeper.urls'
...
WSGI_APPLICATION = 'PurposesKeeper.wsgi.application'
